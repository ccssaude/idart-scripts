...
sql_update_querys <- 
  c("-- ALTER TABLE public.prescription ADD COLUMN tipodt VARCHAR(255);",
    "-- ALTER TABLE public.prescription ADD COLUMN dispensatrimestral INTEGER NOT NULL DEFAULT 0;",
    "ALTER TABLE public.prescription ADD COLUMN tipods VARCHAR(255);",
    ...
    "ALTER TABLE public.patient ADD COLUMN uuidopenmrs VARCHAR(255);",
