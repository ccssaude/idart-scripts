...
sql_regimes <- "SELECT * from regimeterapeutico "
sql_desactiva_regimes_sem_uuid <- "update public.regimeterapeutico set active =FALSE where regimenomeespecificado ='';   "
sql_desactiva_regimes_regime_esquema_idart <- "update public.regimeterapeutico set active =FALSE where codigoregime ='' or regimeesquemaidart is null;   "
